...
class ScreenshotreqsController < ApplicationController
  ...
  def index
    ...
    # index method sends all screenshot request params to the front page: index.html.erb
  end
  ...
  def create
    ...
    # Creates a new instance of a screenshotreq with data submitted from the form in new.html.erb.
    # When the "submit request" button on the form is clicked, the input URLs and request name
    # is checked against the model validation criteria.
  ...
  def screenshotreq_params
    ...
    # Enable the create method to save screenshot requests with name and urls params.
  end
